...
*Strategic fit* pada level korporat didefinisikan sebagai kondisi di mana aktivitas-rantai-nilai dari bisnis-bisnis yang berbeda memiliki cukup kesamaan untuk memungkinkan transfer sumber daya, *sharing* aktivitas, atau *cross-leverage* kapabilitas dengan biaya marginal yang rendah. Definisi ini perlu dibaca dengan presisi: fit tidak berarti bisnis-bisnis terlihat mirip pada level produk akhir; fit berarti bahwa pada satu atau beberapa tahap *value chain*, bisnis-bisnis tersebut menggunakan aktivitas, sumber daya, atau kapabilitas yang serupa sehingga ada peluang ekonomik untuk berbagi atau memindahkan. Toyota Astra Motor dan Astra Honda Motor memproduksi produk akhir yang berbeda (mobil vs. sepeda motor), namun keduanya berbagi *distribution backbone* Astra, *captive financing* dari Astra Credit Companies, dan *brand trust* Astra di mata konsumen Indonesia — itulah fit yang substantif.

### Empat Tipe *Cross-Business Value-Chain Fit*

TPGS Ch.8 mengidentifikasi empat tipe *value-chain fit* yang menjadi sumber *economies of scope*. **Pertama, *supply chain fit*** — bisnis-bisnis berbagi pemasok yang sama, infrastruktur logistik yang sama, atau *input* yang sama sehingga dapat mengkonsolidasi pembelian dan menurunkan biaya per unit melalui skala pembelian agregat. **Kedua, *R&D dan teknologi fit*** — bisnis-bisnis berbagi platform teknologi inti sehingga investasi R&D dapat di-amortisasi pada beberapa lini produk dan inovasi pada satu bisnis dapat di-*spillover* ke bisnis lain. **Ketiga, *manufacturing fit*** — bisnis-bisnis berbagi proses produksi, fasilitas, atau kapabilitas kualitas, sehingga *learning curve* dan *capacity utilization* dapat dimaksimalkan. **Keempat, *sales/marketing/distribusi/brand fit*** — bisnis-bisnis berbagi saluran distribusi, *brand equity*, atau basis pelanggan sehingga biaya akuisisi pelanggan dan biaya pemasaran dapat di-*spread* lintas beberapa lini produk.

### *Economies of Scope* vs. *Economies of Scale*

Perbedaan antara *economies of scope* dan *economies of scale* sering dicampur, padahal mekanismenya berbeda dan implikasi strategiknya berbeda pula. *Economies of scale* berasal dari pertumbuhan volume pada satu lini produk — biaya tetap di-*spread* pada output yang lebih besar, *learning curve* mendorong efisiensi, dan kekuatan tawar terhadap pemasok meningkat dengan volume. *Economies of scope*, sebagaimana didefinisikan Panzar & Willig (1981) dalam kerangka *production economics*, berasal dari produksi dua atau lebih lini produk yang berbeda secara bersama-sama lebih murah dibandingkan memproduksinya secara terpisah — sumber penghematan adalah *sharing* sumber daya yang sama untuk beberapa output. Teece (1980) memperluas argumen ini dengan menunjukkan bahwa *intangible assets* — kapabilitas R&D, *brand*, *organizational know-how* — sering memiliki karakteristik *public goods* dalam batas perusahaan: penggunaannya untuk satu lini produk tidak mengurangi ketersediaannya untuk lini produk lain.
...
Konsep *strategic fit* berakar pada *contingency theory* yang dirumuskan Lawrence dan Lorsch (1967) dalam karya seminal *Organization and Environment*. Argumen inti contingency theory adalah *no one best way*: tidak ada struktur, strategi, atau sistem manajemen yang superior secara universal; superioritas tergantung pada kecocokan (*fit*) antara elemen-elemen internal organisasi dan kondisi lingkungan eksternal. Studi Lawrence & Lorsch terhadap perusahaan-perusahaan plastik, makanan, dan kontainer menunjukkan bahwa perusahaan yang berhasil dalam lingkungan turbulen mengembangkan struktur yang lebih *differentiated* dan mekanisme integrasi yang lebih kompleks, sementara perusahaan yang berhasil dalam lingkungan stabil mempertahankan struktur yang lebih *integrated* dan formal. Implikasi pedagogiknya untuk literatur strategi: setiap rekomendasi strategik harus *kondisional* pada konteks — pertanyaan yang benar bukan "strategi apa yang terbaik" melainkan "strategi apa yang fit untuk kondisi ini."
